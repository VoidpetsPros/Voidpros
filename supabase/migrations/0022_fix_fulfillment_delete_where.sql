-- ============================================================
-- voidpros — fix "DELETE requires a WHERE clause" in admin_approve_fulfillment
-- Same issue migration 0012 already fixed for submit_fulfillment — this
-- function has the same bare `delete from tmp_item_usage;` with no WHERE.
-- ============================================================
